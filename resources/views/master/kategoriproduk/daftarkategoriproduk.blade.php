...
<div class="page-meta">
    <a href="{{ route('kategoriproduk.create') }}">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <form method="POST" action="{{ route('kategoriproduk.destroy', $kategori->id) }}">
                                    @csrf
                                    @method("DELETE")

                                    <a class="btn btn-light-primary btn-icon bs-tooltip"
                                        href="{{ route('kategoriproduk.edit', $kategori->id) }}" data-bs-toggle="tooltip"
                                    ...
                                    <a class="btn btn-light-danger btn-icon bs-tooltip"
                                        href="{{ route('kategoriproduk.destroy', $kategori->id) }}" data-bs-toggle="tooltip"
