...
<div class="page-meta">
    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">{{ $suppliers->nama }}</li>
...
<div class="row mb-4 layout-spacing">
    ...
    <form method="POST" class="row g-3" action="{{ route('supplier.update', $suppliers->id) }}"
                    ...
                    <div class="col">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                name="nama" placeholder="Masukkan nama..." value="{{ $suppliers->nama }}" required>
                            @error('nama')
                ...
                <div class="row mb-4">
                    <div class="col">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control @error('no_hp') is-invalid @enderror" name="no_hp"
                                placeholder="Masukkan No. Telp..." value="{{ $suppliers->no_hp }}" required>
                            @error('no_hp')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control @error('email') is-invalid @enderror"
                            name="email" placeholder="Masukkan email..." value="{{ $suppliers->email }}">
                        @error('email')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="row mb-4">
                    <div class="col">
                        ...
                        <input type="text" class="form-control @error('alamat') is-invalid @enderror"
                            name="alamat" placeholder="Masukkan alamat..." value="{{ $suppliers->alamat }}">
                        @error('alamat')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="row mb-4">
                    <div class="col-sm-12">
                        ...
                        <textarea class="form-control" rows="3" placeholder="Masukkan keterangan..."
                            value="{{ $suppliers->keterangan }}" name="keterangan"></textarea>
                    </div>
                </div>
