...
<div class="row mb-4 layout-spacing">
    ...
    <form method="POST" class="row g-3" action="{{ route('supplier.update', $detailSupplier[0]->id) }}"
            ...
            <div class="widget-content widget-content-area ecommerce-create-section">
                    ...
                    {{-- <div class="col-4">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control @error('id') is-invalid @enderror" name="id"
                                id="input-kode" name="id" placeholder="Id Supplier" value="{{ $detailSupplier[0]->id }}">
                            @error('id')
                    ...
                    <div class="col">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                id="input-nama" name="nama" placeholder="Nama Supplier"
                                value="{{ $detailSupplier[0]->nama }}">
                            @error('nama')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row mb-4">
                    <div class="col-8">
                        ...
                        <input type="text" class="form-control @error('alamat') is-invalid @enderror" id="input-alamat" name="alamat"
                            placeholder="Alamat" value="{{ $detailSupplier[0]->alamat }}">
                        @error('alamat')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="col">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control @error('no_hp') is-invalid @enderror"
                                id="input-nohp" name="no_hp" placeholder="No. Telp/HP"
                                value="{{ $detailSupplier[0]->no_hp }}">
                            @error('no_hp')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row mb-4">
                    <div class="col">
                        ...
                        <input type="text" class="form-control @error('email') is-invalid @enderror" id="input-email" name="email"
                            placeholder="Email" value="{{ $detailSupplier[0]->email }}">
                        @error('email')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="col-7">
                        ...
                        <input type="text" class="form-control @error('no_rek') is-invalid @enderror" id="input-norek" name="no_rek"
                            placeholder="No. Rekening" value="{{ $detailSupplier[0]->no_rek }}">
                        @error('no_rek')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="row mb-4">
                    <div class="col-sm-12">
                        ...
                        <textarea class="form-control" id="input-keterangan" rows="5" placeholder="Keterangan"
                            value="{{ $detailSupplier[0]->keterangan }}" name="keterangan"></textarea>
                    </div>
                </div>
