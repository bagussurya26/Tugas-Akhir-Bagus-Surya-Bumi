...
@section('title', 'Daftar Kategori Kain')
...
<div class="page-meta">
    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Daftar Kategori Kain</li>
        </ol>
    </nav>
</div>
<!-- /BREADCRUMB -->
...
<div class="page-meta">
    <a href="{{ route('kategorikain.create') }}">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <form method="POST" action="{{ route('kategorikain.destroy', $kategori->id) }}">
                                    @csrf
                                    @method("DELETE")

                                    <a class="btn btn-light-primary btn-icon bs-tooltip"
                                        href="{{ route('kategorikain.edit', $kategori->id) }}" data-bs-toggle="tooltip"
                                    ...
                                    <a class="btn btn-light-danger btn-icon bs-tooltip"
                                        href="{{ route('kategorikain.destroy', $kategori->id) }}" data-bs-toggle="tooltip"
