...
@section('title', 'Daftar Kain Terhapus')

@section('cssdaftardeletedkain')
...
@section('kontendaftardeletedkain')
<!-- BREADCRUMB -->
<div class="page-meta">
    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('kain.index') }}">Kain</a></li>
            <li class="breadcrumb-item active" aria-current="page">Daftar Kain Terhapus</li>
        </ol>
    </nav>
</div>
<!-- /BREADCRUMB -->
                ...
                <table id="style-3" class="table style-3 table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ date('d-m-Y', strtotime($datakain->deleted_at)) }}</td>

                            <td class="text-center">
                                <a class="btn btn-light-primary btn-icon bs-tooltip"
                                    href="{{ route('kain.restore', $datakain->id) }}" data-bs-toggle="tooltip"
