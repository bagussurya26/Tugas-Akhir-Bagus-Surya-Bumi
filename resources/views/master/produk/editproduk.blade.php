            ...
            <div class="widget-content widget-content-area ecommerce-create-section">
                ...
                <div class="row mb-4">
                    <div class="col-4">
                        ...
                        <div class="col-sm-12">
                            <input type="text" value="{{ $detailProduk[0]->id }}"
                ...
                <div class="row mb-4">
                    <div class="col">
                        ...
                        <select class="form-select @error('kategori_pakaians_id') is-invalid @enderror"
                            ...
                            @if ($detailProduk[0]->kategori_pakaians_id == $kategoris->id)
                    ...
                    <div class="col">
                        ...
                        <select class="form-select @error('raks_id') is-invalid @enderror" id="rak" name="raks_id">
                            ...
                            @if ($detailProduk[0]->raks_id == $raks->id)
                ...
                <div class="row mb-4">
                    <div class="col">
                        ...
                        <select class="form-select @error('tipe_fit') is-invalid @enderror" id="fit" name="tipe_fit">
                            <option selected disabled value="">Choose...</option>
                            @if ($detailProduk[0]->tipe_fit == 'Regular')
                            <option value="Regular" selected>Regular</option>
                            @elseif ($detailProduk[0]->tipe_fit == 'Slim')
                    ...
                    <div class="col">
                        ...
                        <select class="form-select @error('tipe_lengan') is-invalid @enderror" id="lengan"
                            name="tipe_lengan">
                            <option selected disabled value="">Choose...</option>
                            @if ($detailProduk[0]->tipe_lengan == 'Pendek')
                            <option value="Pendek" selected>Pendek</option>
                            @elseif ($detailProduk[0]->tipe_lengan == 'Panjang')
                    ...
                    <div class="col">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="input-stok" name="total_qty" placeholder="Stok"
                                value="{{ $detailProduk[0]->total_qty }}" readonly>
                        </div>
                    </div>
                    <div class="col">
                        <label>Harga</label>
                ...
                <div class="row mb-4">
                    <div class="col-sm-12">
                        ...
                        <textarea class="form-control @error('keterangan') is-invalid @enderror"
                            value="{{ $detailProduk[0]->keterangan }}" id="input-keterangan" rows="5" placeholder="Keterangan"
