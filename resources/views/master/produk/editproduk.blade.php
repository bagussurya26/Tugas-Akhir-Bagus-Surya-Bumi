                        ...
                        <form enctype="multipart/form-data" class="row g-3" method="POST"
                                        ...
                                        <table class="table item-table warna">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" value="{{ $item->warna }}"
                                                            class="form-control" name="dataWarna[{{ $index }}][warna]"
                                                            placeholder="Masukkan warna..."
                                                            id="input-warna-{{ $index }}"
                                                            onchange="getResep({{$index}})" required>
                                                    </td>
                                                    <td>
                                                        <input type="file" name="dataWarna[{{ $index }}][foto]"
                                                        ...
                                                        <div class="alert alert-light-info alert-dismissible fade show border-0 mb-4"
                                                            role="alert">
                                                            <strong>{{ $item->foto }}</strong> Silahkan memasukka file
                                                            foto pada input di
                                                            atas jika ingin
                                                            mengganti
                                                            foto.</button>
                            ...
                            <div id="defaultStep-three" class="content" role="tabpanel">
                                <div class="table-responsive">
                                    <table class="table item-table ukuran">
                                        ...
                                        <tbody>
                                            @foreach ($produks->produk_warna[0]->produk_ukuran as $index=>$item)
                                            <tr>
                                                <td class="text-center">
                                                    <h6>{{ $item->ukurans->nama }}</h6>
                                                </td>
                                                <td>
                            ...
                            <div id="defaultStep-four" class="content" role="tabpanel">
                                <div id="area-resep">
                                    ...
                                    @foreach ($produks->produk_warna as $index=>$data)
                                    <div class="invoice-detail-items warna-{{ $index }}" style="padding-top: 10px">
                                        <h5 id="warna-resep-{{ $index }}">{{ $data->warna }}</h5>
                                        <div class="table-responsive">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select class="form-select"
                                                                name="dataResep[{{ $index }}][{{ $idx }}][kain]"
                                                                id="input-kain-{{ $index }}-{{ $idx }}" required>
                                                                <option selected disabled value="">Choose...</option>
                                                        ...
                                                        <td>
                                                            @if ($idx == 0)
                                                            <input type="text" value="UTAMA" class="form-control"
                                                                name="dataResep[{{ $index }}][{{ $idx }}][tipe]"
                                                                readonly>
                                                            @else
                                                            @if ($item->pivot->tipe == 'KOMBINASI')
                                                            <input type="text" value="KOMBINASI" class="form-control"
                                                                name="dataResep[{{ $index }}][{{ $idx }}][tipe]"
                                                                readonly>
                                                            @else
                                                            <input type="text" value="{{ $item->pivot->tipe }}"
                                                                class="form-control"
                                                                name="dataResep[{{ $index }}][{{ $idx }}][tipe]"
                                                                readonly>
                                                            @endif
                                        ...
                                        {{-- <button type="button"
                                            class="btn btn-dark btn-tambah-resep me-3">Tambah</button> --}}
...
<script>
    $(document).ready(function () {
        $('#defaultStep-four input[id^="input-kain-"]').each(function () {
            var id = $(this).attr('id');
            console.log(id);
            new TomSelect(id,{
                create: true,
