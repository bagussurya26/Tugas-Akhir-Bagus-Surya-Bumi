...
@section('cssdaftardeletedproduk')
...
@section('kontendaftardeletedproduk')
<!-- BREADCRUMB -->
<div class="page-meta">
    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('produk.index') }}">Produk</a></li>
            <li class="breadcrumb-item active" aria-current="page">Daftar Produk Terhapus</li>
        </ol>
    </nav>
</div>
<!-- /BREADCRUMB -->
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-light-primary btn-icon bs-tooltip" href="{{ route('produk.restore', $dataproduk->id) }}"
                                    data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" data-original-title="Delete" type="submit"><i
