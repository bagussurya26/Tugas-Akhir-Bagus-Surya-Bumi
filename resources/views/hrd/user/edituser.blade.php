...
<div class="page-meta">
    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">{{ $users->nama }}</li>
            ...
            <div class="widget-content widget-content-area ecommerce-create-section">
                ...
                <div class="row mb-4">
                    <div class="col">
                        ...
                        <div class="col-sm-12">
                            <input type="text" value="{{ $users->nama }}"
                    ...
                    <div class="col-4">
                        ...
                        <select class="form-select @error('role') is-invalid @enderror" name="role" required>
                            ...
                            <option value="Pemilik" {{ $users->role=='Pemilik' ? 'selected' : '' }}>Pemilik</option>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col">
                        ...
                        <div class="col-sm-12">
                            <input type="text" value="{{ $users->real_pass }}"
                ...
                <div class="row mb-4">
                    ...
                    <div class="col">
                        ...
                        <div class="col-sm-12">
                            <input type="text" value="{{ $users->no_hp }}"
