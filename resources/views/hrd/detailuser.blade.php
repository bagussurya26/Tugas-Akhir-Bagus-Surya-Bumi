...
<div class="middle-content container-xxl p-0">
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('hrd.daftaruser')}}">Users</a></li>
            ...
            <div class="user-profile">
                <div class="widget-content widget-content-area">
                    <div class="d-flex justify-content-between">
                        <h3 class="">Profile</h3>
                        <a href="{{route('hrd.settinguser')}}" class="mt-2 edit-profile"> <i data-feather="edit-3"></i></a>
                    </div>
                    <div class="text-center user-info">
                        <img src="{{ asset('assets/src/assets/img/profile-bumi.jpg') }}" alt="avatar" style="width: 100px;">
                        <p class="">Bagus Surya Bumi</p>
                    </div>
